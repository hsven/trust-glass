...
import pt.ulisboa.tecnico.trustglass.BitmapUtils;
import pt.ulisboa.tecnico.trustglass.GraphicOverlay;
import pt.ulisboa.tecnico.trustglass.R;
import pt.ulisboa.tecnico.trustglass.VisionImageProcessor;
import pt.ulisboa.tecnico.trustglass.java.barcodescanner.BarcodeScannerProcessor;
import pt.ulisboa.tecnico.trustglass.java.facedetector.FaceDetectorProcessor;
import pt.ulisboa.tecnico.trustglass.java.labeldetector.LabelDetectorProcessor;
import pt.ulisboa.tecnico.trustglass.java.objectdetector.ObjectDetectorProcessor;
import pt.ulisboa.tecnico.trustglass.java.posedetector.PoseDetectorProcessor;
import pt.ulisboa.tecnico.trustglass.java.segmenter.SegmenterProcessor;
import pt.ulisboa.tecnico.trustglass.java.facemeshdetector.FaceMeshDetectorProcessor;
import pt.ulisboa.tecnico.trustglass.java.textdetector.TextRecognitionProcessor;
import pt.ulisboa.tecnico.trustglass.preference.PreferenceUtils;
...
public final class StillImageActivity extends AppCompatActivity {
  ...
  private static final String KEY_IMAGE_URI = "pt.ulisboa.tecnico.trustglass.KEY_IMAGE_URI";
  private static final String KEY_SELECTED_SIZE = "pt.ulisboa.tecnico.trustglass.KEY_SELECTED_SIZE";
