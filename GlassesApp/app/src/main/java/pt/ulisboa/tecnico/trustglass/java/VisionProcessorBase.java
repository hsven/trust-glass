...
import pt.ulisboa.tecnico.trustglass.CameraImageGraphic;
import pt.ulisboa.tecnico.trustglass.FrameMetadata;
import pt.ulisboa.tecnico.trustglass.GraphicOverlay;
import pt.ulisboa.tecnico.trustglass.InferenceInfoGraphic;
import pt.ulisboa.tecnico.trustglass.ScopedExecutor;
import pt.ulisboa.tecnico.trustglass.TemperatureMonitor;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
  ...
  private void processImage(
    ...
    int wid = frameMetadata.getWidth();
    int hei = frameMetadata.getHeight();
    int rot = frameMetadata.getRotation();
    requestDetectInImage(
